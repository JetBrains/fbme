...
<SubAppType Name="DeliveryServices">
  ...
  <SubAppNetwork>
    ...
    <FB Name="S5_OFF_MERGE" Type="E_MERGE" x="4400" y="2130" />
    <DataConnections>
      <Connection Source="configurationID" Destination="W1W2_FB.configurationID" dx1="30" />
    ...
    <EventConnections>
      <Connection Source="W1W2_FB.DONE" Destination="W1W2_DONE" dx1="33" />
      ...
      <Connection Source="W1W2_FB.S1_ON" Destination="S1_ON_MERGE.EI1" dx1="799" />
      <Connection Source="W1W2_FB.S2_ON" Destination="S2_ON_MERGE.EI1" dx1="1159" />
      <Connection Source="W1W2_FB.S3_DELIVERY" Destination="S3_DELIVERY_MERGE.EI1" dx1="396" />
      <Connection Source="W1W2_FB.SR_OUTPUT" Destination="SR_OUTPUT" dx1="353" />
      <Connection Source="W1W2_FB.REQ_CONFIG" Destination="CONFIG_FEED" dx1="243" />
      <Connection Source="CONFIG" Destination="W1W2_FB.CONFIG" dx1="51" />
      <Connection Source="CONFIG" Destination="W3W4_FB.CONFIG" dx1="263" />
      <Connection Source="CONFIG" Destination="W3W1_FB.CONFIG" dx1="263" />
      <Connection Source="W1W2" Destination="W1W2_FB.TRIGGER" dx1="33" />
      ...
      <Connection Source="S3_DELIVERED" Destination="W1W2_FB.S3_DELIVERED" dx1="37" />
      <Connection Source="S3_DELIVERED" Destination="W4W2_FB.S3_DELIVERED" dx1="107" />
      <Connection Source="S1_SENSOR" Destination="W1W2_FB.S1_SENSOR" dx1="43" />
      <Connection Source="S1_SENSOR" Destination="W4W2_FB.S1_SENSOR" dx1="176" />
      <Connection Source="S2_SENSOR" Destination="W1W2_FB.S2_SENSOR" dx1="43" />
      <Connection Source="S2_SENSOR" Destination="W4W2_FB.S2_SENSOR" dx1="176" />
      <Connection Source="SR_SENSOR" Destination="W1W2_FB.SR_SENSOR" dx1="40" />
      ...
      <Connection Source="W4W2_FB.S1_ON" Destination="S1_ON_MERGE.EI2" dx1="70" />
      <Connection Source="S2_ON_MERGE.EO" Destination="S2_ON" dx1="315" />
      <Connection Source="W4W2_FB.S2_ON" Destination="S2_ON_MERGE.EI2" dx1="440" />
      ...
      <Connection Source="W4W2_FB.S3_DELIVERY" Destination="S3_DELIVERY_MERGE.EI2" dx1="537" />
      ...
      <Connection Source="W1W2_FB.S1_OFF" Destination="S1_OFF_MERGE.EI1" dx1="70" />
      <Connection Source="W1W2_FB.S2_OFF" Destination="S2_OFF_MERGE.EI1" dx1="1099" />
      <Connection Source="S1_OFF_MERGE.EO" Destination="S1_OFF" dx1="261" />
      <Connection Source="S2_OFF_MERGE.EO" Destination="S2_OFF" dx1="192" />
      <Connection Source="W4W2_FB.S2_OFF" Destination="S2_OFF_MERGE.EI2" dx1="473" />
      <Connection Source="W4W2_FB.S1_OFF" Destination="S1_OFF_MERGE.EI2" dx1="93" />
      <Connection Source="W2W3_FB.S3_OFF" Destination="S3_OFF" dx1="284" />
      <Connection Source="W2W3_FB.S4_OFF" Destination="S4_OFF" dx1="85" />
      <Connection Source="W3W4_FB.S5_OFF" Destination="S5_OFF_MERGE.EI1" dx1="87" />
      <Connection Source="S5_OFF_MERGE.EO" Destination="S5_OFF" dx1="183" />
      <Connection Source="W3W1_FB.S5_OFF" Destination="S5_OFF_MERGE.EI2" dx1="77" />
      <Connection Source="RESET" Destination="W1W2_FB.RESET" dx1="77" />
      ...
      <Connection Source="RESET" Destination="W4W2_FB.RESET" dx1="293" />
      <Connection Source="W4W2_FB.S6_OFF" Destination="S6_OFF" dx1="150" />
      <Connection Source="W1W2_FB.SR_OFF" Destination="SR_OFF" dx1="210" />
    </EventConnections>
  </SubAppNetwork>
</SubAppType>
