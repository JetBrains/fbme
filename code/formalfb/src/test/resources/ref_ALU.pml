...
proctype ALU(chan
  ...
  s0_osm:
	...
	ExistsEnabledECTran = (
		...
		|| (Q == ALU_SumOp_ecc && trans_DiffOp_START)
		|| (Q == ALU_START_ecc && trans_START_DiffOp)
		|| (Q == ALU_DiffOp_ecc && trans_SumOp_START));
	...
	atomic {
		...
		:: (Q == ALU_SumOp_ecc && trans_DiffOp_START) -> Q = ALU_START_ecc;
		:: (Q == ALU_START_ecc && trans_START_DiffOp) -> Q = ALU_DiffOp_ecc;
		:: (Q == ALU_DiffOp_ecc && trans_SumOp_START) -> Q = ALU_START_ecc;
