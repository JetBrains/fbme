...
<solution name="org.fbme.scenes" uuid="836d7b1e-a51f-4ec1-a3cc-1c0b7cb75eb9" moduleVersion="0" pluginKind="PLUGIN_OTHER" compileInMPS="true">
  <models>
  ...
  <stubModelEntries>
    <stubModelEntry path="${module}/lib/scenes.jar" />
  </stubModelEntries>
  <sourcePath />
  <dependencies>
