...
class MonitoringAction_UnwatchECCState : AnAction(), DumbAware {
    ...
    override fun update(event: AnActionEvent) {
        ...
        event.executeReadAction {
            ...
            event.presentation.isEnabledAndVisible = NetworkWatchActions(element, editorCell, project).hasWatchedEcc()
        }
    }
    ...
    override fun actionPerformed(event: AnActionEvent) {
        event.executeWriteActionInEditor {
            ...
            NetworkWatchActions(element, cell, project).unwatchEcc()
        }
    }
}
