...
class MonitoringAction_WatchFB : AnAction() {
    ...
    override fun update(event: AnActionEvent) {
        ...
        event.executeReadAction {
            ...
            if (actions.hasFunctionBlockToWatch()) {
                event.presentation.isEnabledAndVisible = true
                event.presentation.text = "Watch for Function block " + actions.functionBlock!!.name
            }
        }
    }
    ...
    override fun actionPerformed(event: AnActionEvent) {
        event.executeWriteActionInEditor {
            ...
            NetworkWatchActions(element, cell, project).watchFunctionBlock()
        }
    }
}
