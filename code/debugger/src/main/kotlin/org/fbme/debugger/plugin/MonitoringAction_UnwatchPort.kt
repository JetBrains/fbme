...
class MonitoringAction_UnwatchPort : AnAction(), DumbAware {
    ...
    override fun update(event: AnActionEvent) {
        ...
        event.executeReadAction {
            ...
            if (actions.hasWatchedPort()) {
                event.presentation.isEnabledAndVisible = true
                event.presentation.text = "Stop Watching for Port " + actions.portToWatch()
            }
        }
    }
    ...
    override fun actionPerformed(event: AnActionEvent) {
        event.executeWriteActionInEditor {
            ...
            NetworkWatchActions(element, cell, project).unwatchPort()
        }
    }
}
