...
class MonitoringAction_UnwatchSelectedFBs : AnAction() {
    ...
    override fun update(event: AnActionEvent) {
        ...
        event.executeReadAction {
            ...
            event.presentation.isEnabledAndVisible =
                NetworkWatchActions(element, editorCell, project).hasWatchedFunctionBlocksInSelection()
        }
    }
    ...
    override fun actionPerformed(event: AnActionEvent) {
        event.executeWriteActionInEditor {
            ...
            NetworkWatchActions(element, cell, project).unwatchSelectedFunctionBlocks()
        }
    }
}
