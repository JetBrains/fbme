...
class MonitoringAction_WatchSelectedFBs : AnAction(), DumbAware {
    ...
    override fun update(event: AnActionEvent) {
        ...
        event.executeReadAction {
            ...
            event.presentation.isEnabledAndVisible =
                NetworkWatchActions(element, editorCell, project).hasFunctionBlocskToWatchInSelection()
        }
    }
    ...
    override fun actionPerformed(event: AnActionEvent) {
        event.executeWriteActionInEditor {
            ...
            NetworkWatchActions(element, cell, project).watchSelectedFunctionBlocks()
        }
    }
}
