...
class MonitoringAction_WatchECCState : AnAction() {
    ...
    override fun update(event: AnActionEvent) {
        ...
        event.executeReadAction {
            ...
            event.presentation.isEnabledAndVisible = NetworkWatchActions(element, editorCell, project).hasEccToWatch()
        }
    }
    ...
    override fun actionPerformed(event: AnActionEvent) {
        event.executeWriteActionInEditor {
            ...
            NetworkWatchActions(element, cell, project).watchEcc()
        }
    }
}
