...
class BasicFBTypeNxtPrinter(declaration: BasicFBTypeDeclaration) :
    BasicFBTypePrinter(declaration) {
    override fun printDeclarationBody(element: Element) {
        //super.printDeclarationBody(element)
    ...
    override fun printStateTransition(stateTransition: StateTransition): Element {
        val element = super.printStateTransition(stateTransition)

        val attributeElement = Element("Attribute")
        attributeElement.setAttribute("Name", "Configuration.Transaction.BezierPoints")
        attributeElement.setAttribute("Value", "0,0,0,0") // TODO, need to get these from somewhere
...
class BasicFBTypeNxtPrinter1(declaration: BasicFBTypeDeclaration) :
    ...
    private fun printStateTransition(stateTransition: StateTransition): Element {
        ...
        val attributeElement = Element("Attribute")
        attributeElement.setAttribute("Name", "Configuration.Transaction.BezierPoints")
        attributeElement.setAttribute("Value", "TODO")
        element.addContent(attributeElement)
