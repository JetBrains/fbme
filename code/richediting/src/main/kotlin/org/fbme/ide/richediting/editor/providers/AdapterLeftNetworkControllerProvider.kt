...
class AdapterLeftNetworkControllerProvider: EditorProjectionControllerProvider("Left Network") {
    override fun isApplicable(element: PlatformElement): Boolean {
        return (element as? ExtendedAdapterTypeDeclaration)?.leftNetwork != null
    }
