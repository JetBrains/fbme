...
<model ref="r:fa6c636c-b2b7-439c-9e62-8550571c6e77(org.fbme.ide.meta.editor.editor)">
  ...
  <imports>
    ...
    <import index="g3qn" ref="r:9a144fca-becd-4385-a025-398ace28742a(org.fbme.ide.meta.editor.structure)" implicit="true" />
  ...
  <node concept="24kQdi" id="4s7KBSjs6IQ">
    <ref role="1XX52x" to="g3qn:4s7KBSjs5FZ" resolve="CellModel_BorderedRefNodeList" />
    <node concept="3EZMnI" id="4s7KBSjsfXC" role="2wV5jI">
      <ref role="1k5W1q" to="tpc5:i0pPgF8" resolve="rootCellModelStyle" />
      <node concept="2iRfu4" id="4s7KBSjsfXD" role="2iSdaV" />
      <node concept="3F0ifn" id="4s7KBSjsfXG" role="3EZMnx">
        <property role="3F0ifm" value="bordered" />
      </node>
      <node concept="3EZMnI" id="4s7KBSjsfXL" role="3EZMnx">
        <node concept="VPM3Z" id="4s7KBSjsfXN" role="3F10Kt" />
        <node concept="3EZMnI" id="hd05McM" role="3EZMnx">
          ...
          <node concept="VPM3Z" id="4s7KBSjsiir" role="3F10Kt" />
        </node>
        <node concept="3EZMnI" id="4s7KBSjsm$t" role="3EZMnx">
          <node concept="VPM3Z" id="4s7KBSjsm$v" role="3F10Kt" />
          <node concept="3F0ifn" id="4s7KBSjsm$x" role="3EZMnx">
            <property role="3F0ifm" value="header" />
          </node>
          <node concept="3F0ifn" id="4s7KBSjsmPC" role="3EZMnx">
            <property role="3F0ifm" value=":" />
            <node concept="11L4FC" id="4s7KBSjsmPK" role="3F10Kt">
              <property role="VOm3f" value="true" />
            </node>
          </node>
          <node concept="3F1sOY" id="4s7KBSjsmPM" role="3EZMnx">
            <ref role="1NtTu8" to="g3qn:4s7KBSjslgq" resolve="headerCell" />
          </node>
          <node concept="2iRfu4" id="4s7KBSjsm$y" role="2iSdaV" />
        </node>
        <node concept="3EZMnI" id="4s7KBSjsmPS" role="3EZMnx">
          <node concept="VPM3Z" id="4s7KBSjsmPT" role="3F10Kt" />
          <node concept="3F0ifn" id="4s7KBSjsmPU" role="3EZMnx">
            <property role="3F0ifm" value="footer" />
          </node>
          <node concept="3F0ifn" id="4s7KBSjsmPV" role="3EZMnx">
            <property role="3F0ifm" value=":" />
            <node concept="11L4FC" id="4s7KBSjsmPW" role="3F10Kt">
              <property role="VOm3f" value="true" />
            </node>
          </node>
          <node concept="3F1sOY" id="4s7KBSjsmPX" role="3EZMnx">
            <ref role="1NtTu8" to="g3qn:4s7KBSjslgs" resolve="footerCell" />
          </node>
          <node concept="2iRfu4" id="4s7KBSjsmPY" role="2iSdaV" />
        </node>
        <node concept="2iRkQZ" id="4s7KBSjsfXQ" role="2iSdaV" />
      </node>
    </node>
          ...
          <node concept="1QoScp" id="3ZqNA5AjMi5" role="3EZMnx">
            ...
            <node concept="3F0A7n" id="3ZqNA5AjMin" role="1QoS34">
              ...
              <node concept="A1WHu" id="1o9RazLy6IL" role="3vIgyS">
                <ref role="A1WHt" to="tpc5:1o9RazLy10R" resolve="CellModel_RefNodeList_UsesFoldingMenu" />
              </node>
            </node>
          </node>
